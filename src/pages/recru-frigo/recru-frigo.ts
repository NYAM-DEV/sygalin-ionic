...
/**
 * Generated class for the RecruFrigoPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-recru-frigo',
  templateUrl: 'recru-frigo.html',
})
export class RecruFrigoPage {
	...
	constructor(
		...
		console.log(this._SYGALIN.kits);
	}
	ngOnInit() {
		...
		this.formgroup = new FormGroup({
			...
			formule: new FormControl('2', [Validators.required]),
	...
	myRecruitments() {
		this.navCtrl.push("MesrecuFrigoPage", {page: 'forPDV'});
	}
	...
	simuler():void {
		if (this.formgroup.controls['duree'].value && this.formgroup.controls['formule'].value && this.formgroup.controls['kit'].value && this.formgroup.controls['option'].value  ) {
